...
export default function Mediq() {
  ...
  return (
    <>
      <Card header="Mediq - Web Application">
        <div class="flex items-center gap-8">
          <img class="basis-1/4" src="/mediq/mediq0-Logo.png"/>
          <p class="grow"><b>Role:</b> UX & UI Design, Front-end development (Angular)</p>
        </div>
      </Card>
      ...
      <p><img src="/mediq/mediq2-flow map.png" alt="Process flow for MEDIQ"/></p>
      <h3>
      ...
      <p><img src="/mediq/mediq3-4-JTBDs.png" alt="jobs to be done for internal and external users" /></p>
      ...
      <p><img src="/mediq/mediq5-Design Brief.png" alt="" /></p>
      <p>
      ...
      <p><img src="/mediq/mediq6-Initial Sketches.png" alt="design brief for the project" /></p>
      <p>
      ...
      <p><img src="/mediq/mediq7-Second Sketches.png" alt="paper sketches of the new UI" /></p>
      <p>
        &hellip;and then moved on from that to digital renderings:
      </p>
      <p><img src="/mediq/mediq8Data Quality 2.png" alt="prototype screen" /></p>
      ...
      <h3>User Testing</h3>
      <p><img src="/mediq/mediq9-user_testing.png" alt="a user and user researcher looking at an application" /></p>
      <p>
      ...
      <p><img class="mb-2" src="/mediq/mediq10.1-Home.png" alt="login page for the new app" /></p>
      <p><img src="/mediq/mediq10.2-dq.png" alt="one of the interactive pages for the new app" /></p>
    </>
  )
}