export default function Tradeshow() {
  ...
  return (
    <>
      <h3 class="mb-2">Career Tradeshow - Digital and Physical Design</h3>
      <img height="60" src="/tradeshow/activate1-logo.png" alt="Activate NC logo" />
      <p><b>My role:</b> Logo &amp; print design; digital signage; website design/development</p>
      <p><b>Project brief: </b>
      ...
      <img src="/tradeshow/tradeshow1-figma-screens.png" alt="Figma screens with components for digital and physical signs and banners" />
      <p>
        <img src="/tradeshow/tradeshow2-digital-designs.png" alt="Left to right: a 6-foot banner, digital signage, and an email" />
      </p>
      ...
      <img src="/tradeshow/tradeshow3-ribbit-screenshot.png" alt="screenshot of the website" />
      ...
      <img src="/tradeshow/tradeshow4-physical-items.png" alt="" />
    </>
  )
}