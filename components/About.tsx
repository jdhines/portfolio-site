  ...
  return (
    <section id="about-me">
      ...
      <p class="mt-8">
        ...
        design, development, agile leadership, and strong communication and
        presentation skills, I&rsquo;m dedicated to improving every project I
        take part in. Learning is a lifelong endeavor for me, and as a tech
        lead, my goal is to encourage growth and build up teams into
        cooperative, efficient, and effective groups that consistently deliver
